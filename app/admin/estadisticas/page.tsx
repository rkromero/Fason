    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 md:ml-64">
        <div className="bg-white sticky top-0 z-10 shadow-md border-b border-gray-200 px-4 sm:px-6 py-4 sm:py-6">
          <h1 className="text-2xl sm:text-3xl font-medium text-gray-900">Estadísticas</h1>
          <p className="text-sm text-gray-600 mt-1">Métricas y reportes de ventas</p>
        </div>
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-gray-400">
          <BarChart3 className="h-16 w-16" />
          <p className="text-lg font-medium">Estadísticas en construcción</p>
